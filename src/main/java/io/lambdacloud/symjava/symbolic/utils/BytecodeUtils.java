...
public class BytecodeUtils {
	...
	public static ClassGen genClassBytecodeFunc(Func fun, boolean writeClassFile, boolean staticMethod) {
		...
		ClassGen cg = new ClassGen(fullClsName, "java.lang.Object",
				"<generated>", ACC_PUBLIC | ACC_SUPER, new String[]{"io.lambdacloud.symjava.bytecode.BytecodeFunc"});
	...
	public static ClassGen genClassBytecodeBatchFunc(String className, List<Expr> exprs, List<Integer> outPos, Expr[] args, 
		...
		ClassGen cg = new ClassGen(fullClsName, "java.lang.Object",
				"<generated>", ACC_PUBLIC | ACC_SUPER, new String[]{"io.lambdacloud.symjava.bytecode.BytecodeBatchFunc"});
		ConstantPoolGen cp = cg.getConstantPool(); // cg creates constant pool
		InstructionList il = new InstructionList();
		InstructionFactory factory = new InstructionFactory(cg);
...
//		il.append(InstructionConstants.ARETURN);
	...
	public static ClassGen genClassBytecodeVecFunc(String className, Expr expr, Expr[] args,
		...
		String fullClsName = packageName+"."+className;
		ClassGen cg = new ClassGen(fullClsName, "java.lang.Object",
				"<generated>", ACC_PUBLIC | ACC_SUPER, new String[]{"io.lambdacloud.symjava.bytecode.BytecodeVecFunc"});
		ConstantPoolGen cp = cg.getConstantPool(); // cg creates constant pool
		InstructionList il = new InstructionList();
		InstructionFactory factory = new InstructionFactory(cg);
		LocalVariableGen lg;
